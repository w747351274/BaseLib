#
#  Be sure to run `pod spec lint ClsLib.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/w747351274/ClsLib.git", :tag => "0.0.1" }
  ...
  s.subspec 'Util' do |util|
    ...
    httpUtil.dependency 'AFNetworking', '~> 3.0.1'
    end
